...
<details>
  <summary>Распредение IP-адресов </summary>
...
### Cхема сети
![Изображение](https://github.com/takmenevag/otus-dc-design/blob/main/labs/lab7/scheme/lab7_scheme2.PNG "Схема стенда")
...
|dc1-leaf-101	|Po7	|10.2.20.254/24	|Клиентская сеть, VLAN 20|
|dc1-leaf-101	|Po8	|10.2.20.254/24	|Клиентская сеть, VLAN 20|
|dc1-leaf-102	|Po7	|10.2.10.254/24	|Клиентская сеть, VLAN 10|
|dc1-leaf-102	|Po7	|10.2.20.254/24	|Клиентская сеть, VLAN 20|
