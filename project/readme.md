...
Описание:
- Для DC1, DC2 и DCI испольузется блок IP-адресов 10.Х.0.0/12
...
- В блок /16 для POD выделяется:
	...
	- блок /23 для loopback интерфейсов СПД ЦОД
...
_Соответствие типа оборудования и его номера_
|Тип| Оборудование|
|:-	|:-|
|0	|host|
|1	|leaf|
...
_Расположение оборудования по ТШ с резервированием места_
...
<details>
  <summary>Итоговая таблица наименования и расположения </summary>
  
_В лабе взяты AS 65xxx для облегчения просмотра выводов команд_
|ТШ	|Имя AS				|Наименование		|Номер AS	|Cокращение |AS лаба|
|:-	|:-					|:-					|:-			|:-			|:-|
